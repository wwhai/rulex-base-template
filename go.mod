module rulex-gateway

go 1.17

require (
	github.com/i4de/rulex v0.0.0-20220919070501-03aaccdb4924
...
require (
	...
	github.com/wwhai/gomodbus v0.2.2 // indirect
	github.com/wwhai/goserial v0.2.0 // indirect
